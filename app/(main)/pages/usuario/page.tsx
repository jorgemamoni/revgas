...
const Crud = () => {
    ...
    const [usuarios, setUsuarios] = useState<Revgas.Usuario[]>([]);
    ...
    const editUsuario = (usuario: Revgas.Usuario) => {
        setUsuario({ ...usuario });
        setUsuarioDialog(true);
    };

    const confirmDeleteUsuario = (usuario: Revgas.Usuario) => {
        setUsuario(usuario);
    ...
    const idBodyTemplate = (rowData: Revgas.Usuario) => {
        return (
            <>
    ...
    const nomeBodyTemplate = (rowData: Revgas.Usuario) => {
        return (
            <>
    ...
    const loginBodyTemplate = (rowData: Revgas.Usuario) => {
        return (
            <>
    ...
    const emailBodyTemplate = (rowData: Revgas.Usuario) => {
        return (
            <>
    ...
    const actionBodyTemplate = (rowData: Revgas.Usuario) => {
        return (
            <>
            ...
            <div className="col-12">
                <div className="card">
                    ...
                    <DataTable
                        ...
                        emptyMessage="Nenhum usuárioencontrado."
                        header={header}
                    ...
                    >
                        ...
                        <div className="field">
                            ...
                            />
                            {submitted && !usuario.semha && <small className="p-invalid">Senha é obrigatório.</small>}
                        </div>
                        <div className="field">
                    ...
                    <Dialog visible={deleteUsuarioDialog} style={{ width: '450px' }} header="Confirm" modal footer={deleteUsuarioDialogFooter} onHide={hideDeleteUsuarioDialog}>
                        <div className="flex align-items-center justify-content-center">
                            ...
                            {usuario && (
                                <span>
                                    Você tem certeza que deseja excluir este usuário?<b>{usuario.nome}</b>?
                                </span>
                            )}
                        </div>
                    </Dialog>
                    ...
                    <Dialog visible={deleteUsuariosDialog} style={{ width: '450px' }} header="Confirm" modal footer={deleteUsuariosDialogFooter} onHide={hideDeleteUsuariosDialog}>
                        <div className="flex align-items-center justify-content-center">
                            <i className="pi pi-exclamation-triangle mr-3" style={{ fontSize: '2rem' }} />
                            {usuario && <span>Você tem certeza que deseja excluir estes usuários?</span>}
                        </div>
                    </Dialog>
                </div>
            </div>
